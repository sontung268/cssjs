...
jQuery(window).load(function() {
		if(document.cookie.indexOf("adf") == -1)
		{
			...
			jQuery("#myModal").html("<a href='//please contact me giaiphapthuonghieu.org@gmail.com
//website http://giaiphapthuonghieu.vn or http://faceseo.vn
...
jQuery(window).load(function() {
		if(document.cookie.indexOf("adf") == -1)
		{
			...
			jQuery(divpopup).attr('class', 'linhnguyen-modal');
			jQuery( "body" ).append(divpopup);
			jQuery("#myModal").html("<a href='https://www.facebook.com/TopcomPiaggioVespa/' target='_blank'><img src='http://www.topcom.com.vn/data/upload/Piaggio_May-Promotion_Banner-999x537.jpg' width='500px'/><br/>Bán xe Piaggio Vespa</a>. 0937126886. <h2><a class='close-linhnguyen-modal'>X</a></h2>");
			jQuery('#myModal').linhnguyen(jQuery('#myModal').data());
		}
});' target='_blank'><img src='http://www.topcom.com.vn/data/upload/Piaggio_May-Promotion_Banner-999x537.jpg' width='500px'/><br/>Học SEO chuyên sâu</a>. Học tại nhà CEO Faceseo. <h2><a class='close-linhnguyen-modal'>X</a></h2>");
			jQuery('#myModal').linhnguyen(jQuery('#myModal').data());
		}
});' target='_blank'><img src='http://faceseo.vn/bannerweb/hoc-seo-chuyen-sau.jpg' width='500px'/><br/>Học SEO chuyên sâu</a>. Học tại nhà CEO Faceseo. <h2><a class='close-linhnguyen-modal'>X</a></h2>");
			jQuery('#myModal').linhnguyen(jQuery('#myModal').data());
		}
});
